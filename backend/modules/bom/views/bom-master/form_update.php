...
$this->title = 'Update Bom Master: ' . $model->id;
...
<div class="row">
    <div class="col-md-12">
        ...
        <!--<input type="hidden" class="form-control product_qty" name="create[1][product]" placeholder="Product" id="product-1">-->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="formrow">
                                                        <input type="number"  min="1" autocomplete="off"  step="any" class="form-control product_qty" name="create[<?= $bom->id ?>][product_qty]" placeholder="Quantity" id="product_qty-1" value="<?= $bom->qty ?>"required readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="formrow">
                                                        <input type="text" class="form-control product_comment" name="create[<?= $bom->id ?>][product_comment]" placeholder="Product Comment" id="product_comment-1">
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <!--                                                    <div class="formrow">
                                                            ...
                                                            foreach ($material_details as $value) {
                                                                ...
                                                                <tr style="border: none;">
                                                                    <td style="padding: 6px 0px;width: 50%;">
                                                                        <div class="col-md-8">
                                                                            <div class="formrow">
                                                                                <select class="form-control" name="creatematerial[<?= $value->id ?>][material_id][]">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="formrow">
                                                                                <input id="material_qty_val_<?= $bom->id ?>-<?= $k ?>" type="hidden" autocomplete="off" class="form-control" name="creatematerial[<?= $bom->id ?>][material_qty_val][]" value="<?= $value->quantity ?>"placeholder="Material" required readonly>
                                                                                <input id="material_qty_<?= $bom->id ?>-<?= $k ?>" data-val="<?= $bom->id ?>" type="number" min="1" max="<?= $avail ?>" autocomplete="off" class="form-control material_qty" name="creatematerial[<?= $bom->id ?>][material_qty][]" value="<?= $value->quantity ?>"placeholder="Qty" required>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-md-12">
                                                                            <div class="formrow">
                                                                                <input id="material_comment_<?= $bom->id ?>" type="text" autocomplete="off" class="form-control" name="creatematerial[<?= $bom->id ?>][material_comment][]" value=""placeholder="Comment">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
