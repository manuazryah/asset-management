...
<div class="material-adjustment-master-form form-inline">
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#add_another_line', function (e) {
            ...
            $.ajax({
                ...
                url: homeUrl + 'stock/material-adjustment-master/add-another-row',
    ...
    function itemChange(item_id, current_row_id) {
        ...
        $.ajax({
            ...
            url: '<?= Yii::$app->homeUrl; ?>stock/material-adjustment-master/get-items',
            success: function (data) {
                var res = $.parseJSON(data);
